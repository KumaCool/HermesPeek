...
def _reset_preview_delivery_state(session_id: str = "", **_: Any) -> None:
    """Clear stale delivery state at the start of every agent turn."""
    if not session_id:
        return
...
def _record_successful_preview_delivery(
    ...
    """Remember a confirmed direct Preview send for final-response suppression."""
...
def _suppress_confirmation_after_preview(
    ...
    """Replace commentary after a confirmed send with Hermes' silence marker."""
